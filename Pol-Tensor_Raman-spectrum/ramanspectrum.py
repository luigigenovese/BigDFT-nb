"""
File containing the class allowing to compute the Raman Spectrum of 
a molecular system with BigDFT.
"""
...
class RamanSpectrumCalc(BigDFTCalc):
    ...
    def __init__(self, input_yaml, posinp, alpha_x=1./64., \
            calc_intensities=True, ef_amplitudes=[1.E-4]*3, prefix=None, \
            run_folder=None, ref_calc=None):
        """
        ...
        super(RamanSpectrumCalc, self).__init__(input_yaml, posinp, \
            prefix=prefix, run_folder=run_folder, ref_calc=ref_calc)
        ...
        for i_at, atom_dir in enumerate(self.atom_dirs):
            ...
            for i, coord in enumerate(COORDS):
                ...
                for sign in SIGNS:
                    ...
                    run_folder = os.path.join(self.run_folder, atom_dir, mv_dir)
    ...
    def build_hessian(self):
        ...
        for i_at, atom_dir in enumerate(self.atom_dirs):
            ...
            for i, coord in enumerate(COORDS):
                ...
                logs = [lf.Logfile(self.logfiles_paths[atom_dir][coord][j]) \
                        for j in range(2)]
