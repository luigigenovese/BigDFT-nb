    ...
    * the other to actually run the calculation.
    ...
    def __init__(self, input_yaml, posinp, prefix=None, run_folder=None, \
        ...
        if run_folder is None:
            ...
            common_prefix = os.path.commonprefix([self.init_folder, run_folder])
            ...
            # common prefix.
                ...
                self.init_folder = common_prefix
                self.run_folder = os.path.relpath(run_folder, common_prefix)
        ...
        try:
            ...
            if ref is not None:
                ...
                if os.path.exists(ref_data_path):
                    ...
                    print("No data folder found for the reference calculation.")
            ...
            self.logfile_path = os.path.join(\
                                    self.abs_folder, self.output_name)
